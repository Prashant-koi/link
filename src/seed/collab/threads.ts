...
export const THREADS: ThreadDef[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      { id: "c10", day: 7, hour: 1, spanHours: 3, n: 14, brief: "Hackathon night infra: Chen watches logs while people demo, a scare when the worker container restarts, the box's disk fills with Docker layers and he prunes it; everything holds through the demo." },
